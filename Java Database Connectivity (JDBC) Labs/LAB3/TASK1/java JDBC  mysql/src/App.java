...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ArrayList<ContactPerson> contacts = db.getAllContactsUsingRowSet();
        contacts.forEach((ContactPerson) -> System.out.println(ContactPerson.getName()));
        contacts.forEach((ContactPerson) -> System.out.println(ContactPerson.getAddress()));
        contacts.forEach((ContactPerson) -> System.out.println(ContactPerson.getCellphone()));
        contacts.forEach((ContactPerson) -> System.out.println(ContactPerson.getBirthday()));
        ...
        /// example: UPDATE contacts SET email = how@gamil.com WHERE nickname = John;
        // db.updateContacts("email", "how@gamil.com", "nickname", "John");
