...
public class dataBaseApp {
    ...
    public void updateContacts(ContactPerson cp) {
        try {
            ...
            stmt.executeUpdate();
            if (stmt.executeUpdate() > 0) {
                // print out a message if the Updated was successful
    ...
    public void updateContactsBatch() {
        try {
            ...
            // create 2 update statements
            String sql1 = "UPDATE contacts SET email = 'test@mail.com' WHERE name = 'ITI'";
            String sql2 = "UPDATE contacts SET email = 'test@mail.com' WHERE name = 'MCIT'";
            ...
            if (stmt.executeBatch() != null) {
                ...
                // print out a message if the update was successful
                System.out.println("A contact was updated successfully!");
                stmt.close();
            }
            // close connection
